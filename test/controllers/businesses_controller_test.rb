...
describe BusinessesController do
  ...
  it "creates business" do
    expect {
      post businesses_url, params: { business: { account_number: business.account_number, ownership_name: business.ownership_name } }
  ...
  it "updates business" do
    patch business_url(business), params: { business: { account_number: business.account_number, ownership_name: business.ownership_name } }
